...
var Suite = require('mocha/lib/suite'),
    ...
    strategyOf = {
      beforeAll : function(suite, fn, key) {
        fn.should.be.type('function', "suite.beforeAll suite handler");
        suite.beforeAll(fn);
      },
      before: function(suite, fn, key) {
        fn.should.be.type('function', "suite.before suite handler");
        suite.beforeEach(fn);
      },
      after: function(suite, fn, key) {
        fn.should.be.type('function', "suite.after suite handler");
        suite.afterEach(fn);
      },
      afterAll: function(suite, fn, key) {
        fn.should.be.type('function', "suite.afterAll suite handler");
        suite.afterAll(fn);
      },
